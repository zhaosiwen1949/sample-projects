...
static void truth__create_types(struct tm_the_truth_o* tt)
{
    ...
    const uint64_t default_object = tm_the_truth_api->quick_create_object(tt, TM_TT_TYPE_HASH__CUSTOM_COMPONENT, TM_TT_PROP__CUSTOM_COMPONENT__FREQUENCY, 1.0f, TM_TT_PROP__CUSTOM_COMPONENT__AMPLITUDE, 1.0f, -1);
