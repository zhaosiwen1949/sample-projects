...
project "gameplay_sample_first_person_component"
    location "build/gameplay_sample_first_person_component"
    targetname "tm_gameplay_sample_first_person_component"
    kind "SharedLib"
    language "C++"
    files {"*.inl", "*.h", "*.c"}
    sysincludedirs { "" }
