...
workspace "gameplay_sample_interaction_system"
...
project "gameplay_sample_interaction_system"
    location "build/gameplay_sample_interaction_system"
    targetname "tm_gameplay_sample_interaction_system"
    kind "SharedLib"
    language "C++"
    files {"*.inl", "*.h", "*.c"}
    sysincludedirs { "" }
