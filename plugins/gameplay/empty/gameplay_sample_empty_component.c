...
static void create_truth_types(struct tm_the_truth_o* tt)
{
    ...
    const tm_tt_id_t component = tm_the_truth_api->create_object_of_type(tt, tm_the_truth_api->object_type_from_name_hash(tt, TYPE_HASH__GAMEPLAY_SAMPLE_EMPTY_COMPONENT), TM_TT_NO_UNDO_SCOPE);
    (void)component;
