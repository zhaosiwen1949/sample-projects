...
{
    tm_entity_api->call_remove_on_all_entities(manager->entity_ctx, tm_entity_api->lookup_component(manager->entity_ctx, TYPE_HASH__GAMEPLAY_SAMPLE_EMPTY_COMPONENT));
    tm_allocator_i a = manager->allocator;
