...
workspace "ray_tracing_sample_hello_triangle"
...
project "ray_tracing_sample_hello_triangle"
    location "build/ray_tracing_sample_hello_triangle"
    targetname "tm_ray_tracing_sample_hello_triangle"
    kind "SharedLib"
    language "C++"
    files {"*.inl", "*.h", "*.c"}
    sysincludedirs { "" }
